...
def mock_dependencies():
    ...
    ) as mock_get_credentials_mfa:
        mock_session = mock.Mock()
        mock_get_session.return_value = mock_session
        yield mock_get_credentials, mock_get_header_login, mock_session, mock_cookie_jar, mock_logging, mock_get_credentials_mfa
...
def test_sign_in_failed_no_mfa(mock_dependencies):
    ...
    mock_session.post.assert_called_once_with(
        f"{API_ROOT}/auth/signin", "credentials", headers="headers"
    )
